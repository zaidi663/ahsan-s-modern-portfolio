...
const experiences = [
  {
    ...
    location: 'Onsite',
    period: '2023 - Present',
    description: 'Developing and maintaining web applications using modern frontend technologies. Building responsive user interfaces and managing e-commerce platforms.',
    responsibilities: [
      ...
      'Managed e-commerce operations and store customization',
      'Optimized application performance and loading times',
    ],
    tech: ['React', 'Next.js', 'TypeScript', 'Tailwind CSS', 'MUI', 'REST APIs'],
  },
  {
    title: 'Development Internee',
    company: 'Swishtag',
    location: 'Onsite',
    period: '2022 - 2023',
    description: 'Completed internship focused on frontend development and e-commerce management. Gained hands-on experience with modern web technologies and online store operations.',
    responsibilities: [
      'Built responsive web components using React and modern frameworks',
      'Managed Shopify-based online stores and product listings',
      'Customized e-commerce themes and implemented store features',
      'Handled inventory management and product catalog organization',
      'Implemented SEO best practices for improved online visibility',
    ],
    tech: ['React', 'Shopify', 'HTML/CSS', 'JavaScript', 'SEO'],
  },
];
