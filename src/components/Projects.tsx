...
const projects = [
  {
    ...
    description: 'A full-featured online store built with Next.js and integrated with Stripe for payments. Features include product catalog, shopping cart, checkout flow, and order management.',
    image: '/placeholder-ecommerce.jpg',
    tech: ['Next.js', 'Stripe', 'Tailwind CSS', 'Prisma', 'PostgreSQL'],
  ...
  },
  {
    ...
    description: 'A comprehensive dashboard for managing products, inventory, and analytics. Built with React and Material UI with real-time data visualization.',
    image: '/placeholder-dashboard.jpg',
    tech: ['React', 'Material UI', 'Chart.js', 'Redux', 'REST APIs'],
    github: 'https://github.com',
    live: 'https://example.com',
    featured: true,
  },
  {
    title: 'T-Shirt Color Variant Preview',
    description: 'An interactive product customization tool allowing users to preview t-shirts in different colors in real-time. Features smooth animations and color picker.',
